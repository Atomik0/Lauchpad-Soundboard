...
|-- deploy.py                       # Script automatizado de despliegue a la VPS
|-- compilar_win.sh                 # Script bash para compilar instalador Windows (.exe)
|-- compilar_win.bat                # Script batch para compilar instalador Windows (.exe)
|-- compilar_linux.sh               # Script bash para compilar instalador Linux
|-- compilar_linux.bat              # Script batch para compilar instalador Linux desde Windows
...
* **Para compilar paquete de Windows (.exe)**:
  * En Windows: Ejecutar `compilar_win.bat`
  * En Linux: Ejecutar `./compilar_win.sh`
  * La salida se genera en `app/dist_exe/`.

* **Para compilar paquete de Linux**:
  * En Windows: Ejecutar `compilar_linux.bat`
  * En Linux: Ejecutar `./compilar_linux.sh`
