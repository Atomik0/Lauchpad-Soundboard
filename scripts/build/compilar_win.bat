...
if exist "%CLEAN_TEMPLATE%" (
  ...
  echo {"version":1,"currentBankId":"capa_1","bankOrder":["capa_1"],"bankNames":{"capa_1":"Capa 1"},"masterVolume":0.8,"botDiscordVolume":0.8,"pressEffect":1,"idleEffect":11,"blendMode":0,"selectedHeadphonesId":"default","selectedDiscordId":"default","muteLocalOnDiscord":true,"banks":{"capa_1":[]}} > "%CONFIG_FILE%"
)
...
echo ========================================================
echo.
echo   La carpeta limpia lista para tus amigos esta en:
echo   app\dist_exe\Launchpad Studio Pro-win32-x64\
echo.
...
echo.
echo   Solo comprime la carpeta "Launchpad Studio Pro-win32-x64" en ZIP
