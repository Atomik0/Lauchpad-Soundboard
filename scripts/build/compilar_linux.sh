...
echo "  app/dist_linux/Launchpad Studio Pro-v$APP_VERSION-linux-x64/"
echo ""
...
echo ""
echo "  Para compartir con tus amigos en Linux, comprime la carpeta en .tar.gz o .zip:"
echo "  tar -czf 'Launchpad-Studio-Pro-v$APP_VERSION-linux-x64.tar.gz' -C app/dist_linux 'Launchpad Studio Pro-v$APP_VERSION-linux-x64'"
echo "========================================================"
